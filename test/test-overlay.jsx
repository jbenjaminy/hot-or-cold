...
describe('Overlay', function() {
  it('Renders the overlay component when instructions are hidden', function() {
    ...
    instructionsDiv.props.children[0].props.children.should.equal('How do I play?');
    instructionsDiv.props.children[1].type.should.equal('p');
    instructionsDiv.props.children[1].props.children.should.equal('This is a \'Hot-or-Cold\' number-guessing game. Here\'s how it works:');
    ...
    instructionsDiv.props.children[3].type.should.equal('h3');
